        ...
        <>
            <section className="section1">
                <Container>
                    <Grid className="content" container>
                        <Grid item xs={12} md={6}>
                            ...
                            <Typography variant="h2" color="white">Search Futsal Grounds Nearby</Typography>
                           
                        </Grid>
                        <Grid item xs={12} md={6}>
                        <div className="searchTitle">
                        <Typography variant="h6" color="white">Pick your location</Typography>
                        </div>
                            <TextField id="Location" label="Where ?"
                                InputProps={{
                                endAdornment: (
                ...
                <section className = "section2">
                    <Typography variant="h3" textAlign="center" padding="35px 0 35px 0">Recommended For You</Typography>
                    <Container>
